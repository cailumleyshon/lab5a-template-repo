...
function sumAndMultiply(a, b, c) {
  ...
  let multiply2 = multiply(multiply1[0], c);

  let sumMessage = `${a} and ${b} and ${c} sum to ${sum2[0]}.`;
  let multiplyMessage = `The product of ${a} and ${b} and ${c} is ${multiply2[0]}.`;

  return [sum2[0], multiply2[0], sumMessage, multiplyMessage];
}
...
function sumArray(sumArr) {
  ...
  let string = `${sumArr} was passed in as an array of numbers, and ${arraySum} is their sum.`;
